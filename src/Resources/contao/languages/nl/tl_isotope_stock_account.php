...
$GLOBALS['TL_LANG']['tl_isotope_stock_account']['deleteConfirm'] = 'Weet je zeker dat je deze rekening wilt verwijderen?';
$GLOBALS['TL_LANG']['tl_isotope_stock_account']['title'] = ['Titel', ''];
